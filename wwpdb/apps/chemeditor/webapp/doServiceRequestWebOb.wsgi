...
#
# Updated:
# 26-Sep-2018 EP    Ported from fcgi
"""
...
#  - URL mapping and application specific classes are launched from ChemEditorWebApp()
...
class MyRequestApp(object):
    ...
    def __call__(self, environment, responseApplication):
        ...
        ###
        entmodule = ChemEditorWebApp(parameterDict=self._myParameterDict,verbose=self.__verbose, 
...
##
##  NOTE -  Verbose setting are set here ONLY! 
##
